...
const StyledButton = styled.button<{ theme: { [key: string]: string }; width: number | string; borderradius: number | string; active?: boolean; borderWidth: string | number; color ?: string | number; color2 ?: string | number; }>`
  margin-left: -1px;
  margin-right: -1px;
  padding: 1.2vmin;
...
const SelectButton = (props: SelectButtonProps) => {
  return (
    <StyledButton
      onClick={props.event}
      theme={{ borderColor: props.borderColor, bgColor: props.bgColor, deepColor: props.deepColor, color: props.color, color2 : props.color2 || props.deepColor }}
