...
const GuildFutureSprint = (props: GuildFutureSprintProps) => {
  ...
  const [data, setData] = useState([
    ...
    },
    {
      ...
      sprint_name: 'test2',
      sprint_day: 5,
      problem_list: [{ guild_problem_id: 1, problem_id: 1, difficulty: 17, title: '톱니바퀴1' }],
    },
  ]);
  ...
  return (
    <>
      {isProblem === 0 ? (
        ...
        <GuildFutureMakeProblem problemList={getSprintProblemList(isProblem)} guild_id={props.guild_id} setIsProblem={setIsProblem} />
      )}
    </>
  );
};
