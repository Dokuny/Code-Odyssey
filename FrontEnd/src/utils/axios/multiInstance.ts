...
import { BASE_URL, MULTI_TYPE, TIMEOUT } from '../../config/Axios';
...
multiInstance.interceptors.request.use(setCommonHeaders, handleRequestError);
multiInstance.interceptors.response.use(handleResponseSuccess, handleResponseError);
